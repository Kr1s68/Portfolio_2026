...
const TREE = [
  ...
  {
    id: 'freelance', label: 'freelance', files: [
      { id: 'web-development', label: 'web-development.txt' },
      { id: 'ui-ux-design', label: 'ui-ux-design.txt' },
      { id: 'consulting', label: 'consulting.txt' },
      { id: 'coaching', label: 'coaching.txt' },
    ],
  },
  {
    id: 'recommendations', label: 'recommendations', files: [
      { id: 'rec-1', label: 'placeholder-name.txt' },
    ],
  },
  {
    id: 'about', label: 'about', files: [
                  ...
                  <div className="file-tree__files-inner">
                    {dir.files.map((file, fileIndex) => {
                      ...
                      return (
                        ...
                        >
                          <span className="file-tree__prefix">{filePrefix}</span>
                          <span className="file-tree__file-name">{file.label}</span>
                        </button>
                      )
                    })}
                  </div>
